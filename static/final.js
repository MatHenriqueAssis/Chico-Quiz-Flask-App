document.addEventListener("DOMContentLoaded", function () {
    ...
    if (pontuacao === 100) {
        mensagemTitulo.innerText = `Parabéns, você acertou/fez ${pontuacao}`
        ...
        mensagemTitulo.innerText = `Muito bem, você acertou/fez ${pontuacao}`
        ...
        gif.src = "/static/gifs/grandes/ThugLifeGrande.gif"; // Adicione um GIF intermediário
        console.log("Mensagem: Muito bom! Mas pode melhorar! 💪");
    } else{
        ...
        gif.src = "/static/gifs/grandes/DeBobeiraGrande.gif"; // Adicione um GIF de incentivo
        console.log("Mensagem: Não desanime! Tente novamente! 😅");
    }
